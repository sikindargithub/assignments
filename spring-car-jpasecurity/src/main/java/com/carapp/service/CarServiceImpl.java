...
public class CarServiceImpl implements ICarService {
    ...
    public List<Car> getByBrandAndModel(String brand, String model) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+brand+" and "+model+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByMileage(int mileage) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+mileage+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByPricePerHourLessThan(double pricePerHour) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+pricePerHour+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByNoOfSeats(int noOfSeats) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+noOfSeats+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByColorAndRating(String color, double rating) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+color+" and "+rating+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByRatingAndMileage(double rating, int mileage) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+rating+" and "+mileage+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByDistanceAndFuel(double kmsDriven, String fuelType) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+kmsDriven+" and "+fuelType+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByTransAndInsurance(String transmission, boolean insuranced) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+transmission+" and "+insuranced+" are not found");
        return carsList;
    }
    ...
    public List<Car> getBySeatsAndPickup(int noOfSeats, String pickupType) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+noOfSeats+" and "+pickupType+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByTypeAndPrice(String carType, double pricePerHour) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+carType+" and "+pricePerHour+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByBrandAndPickupAndSeats(String brand, String pickupType, int noOfSeats) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+brand+" , "+pickupType+" and "+noOfSeats+" are not found");
        return carsList;
    }
    ...
    public List<Car> getByMileageAndRatingAndType(int mileage, double rating, String carType) {
        ...
        if(carsList.isEmpty())
            throw new CarNotFoundException("cars are of "+mileage+" , "+rating+" and "+carType+" are not found");
        return carsList;
    }
}
